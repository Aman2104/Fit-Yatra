...
import com.fityatra.activities.ExerciseDescriptionActivity
...
class ExerciseAdapter(private val exercises: List<Exercise>) : RecyclerView.Adapter<ExerciseAdapter.ExerciseViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExerciseViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.exercise_item_layout, parent, false)
    ...
    override fun onBindViewHolder(holder: ExerciseViewHolder, position: Int) {
        ...
        Log.d("image is",url+exercise.image)
        holder.nameTextView.text = exercise.name
        Picasso.get()
            .load(url+exercise.image)
